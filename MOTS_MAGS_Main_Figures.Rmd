...
```{r RUN FIRST BEFORE CREATING ANY FIGURES, warning=FALSE, message=FALSE}

#RUN THIS CHUNK FIRST BEFORE CREATING ANY FIGURES
library("magrittr")
library("ggplot2")
library("forcats")
library("dplyr")
...
raw_read_count <- read.csv("~/base data/raw_read_count_watermass.csv", header = TRUE)
...
pdf("~/base data/for_phylum_legend.pdf",width=7,height=5) # Open a new pdf file
...
pdf("~/base data/Figure_1.pdf", width = 16, height = 18) # Open a new pdf file
...
```{r Figure 2}
mots.data <- read.csv("~/base data/mots_mag_fnct.csv")
...
pdf("~/base data/diamond_plot.pdf", width = 8, height = 10) # Open a new pdf file
...
pdf("~/base data/Figure_2.pdf", width = 14, height = 22) # Open a new pdf file
...
with_season_metadata <- read_excel("~/base data/Nova_metadata_season.xlsx")
...
pdf("~/base data/Figure_3.pdf", width = 15, height = 13)
...
pdf("~/base data/Figure_4.pdf",15, height = 13)
...
pdf("~/base data/Figure_5_free_scale.pdf",15, height = 14)
...
###FOR TARA
#OTU table
tara.mg.otu.csv <- read.csv(file="~/base data/tara_mg_otu.csv", header = TRUE, na.strings = "unclassified", fileEncoding="UTF-8-BOM", check.names = FALSE, row.names = 1)
...
#Taxa table
tara.mg.taxa.csv <- read.csv(file="~/base data/taxa_table.csv", header = TRUE, na.strings = "unclassified", fileEncoding="UTF-8-BOM", check.names = FALSE, row.names = 1)
...
#Meta-data
tara.mg.sample.meta <- read.csv(file="~/base data/tara_mg_meta.csv", header = TRUE, fileEncoding="UTF-8-BOM", check.names = FALSE, row.names = 1)
...
pdf("~/base data/Figure_7.pdf",15, height = 13)
